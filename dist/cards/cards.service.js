...
const user_cards_service_1 = require("../user-cards/user-cards.service");
let CardsService = class CardsService {
    constructor(cardRepository, userCardService) {
    ...
    async findAllByCategoryAndId(category, id) {
...
exports.CardsService = CardsService = __decorate([
    ...
    __metadata("design:paramtypes", [typeorm_2.Repository,
        user_cards_service_1.UserCardsService])
], CardsService);
