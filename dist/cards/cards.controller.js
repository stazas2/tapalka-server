...
let CardsController = class CardsController {
    ...
    findAllByCategoryAndId(category, id) {
        console.log('category cards: ', category);
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], CardsController.prototype, "findAllByCategory", null);
__decorate([
    (0, common_1.Get)('category/:category/:id'),
    __param(0, (0, common_1.Param)('category')),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Number]),
    __metadata("design:returntype", void 0)
], CardsController.prototype, "findAllByCategoryAndId", null);
__decorate([
    (0, common_1.Patch)(':id'),
